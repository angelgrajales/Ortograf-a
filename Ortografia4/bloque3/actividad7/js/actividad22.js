...
var ejercicios = ['<tr id="fila_1"><td id="col_1_1">Va</td><td id="col_1_2"></td><td id="col_1_3"></td></tr><td id="col_1_4"></td></tr>',
    '<tr id="fila_2"><td id="col_2_1">Ve</td><td id="col_2_2"></td><td id="col_2_3"></td></tr><td id="col_2_4"></td></tr>',
    '<tr id="fila_3"><td id="col_3_1">Vo</td><td id="col_3_2"></td><td id="col_3_3"></td></tr><td id="col_3_4"></td></tr>'];
...
function califica(boton) {
    valor = $("#" + boton).text();
    if (pos === 0 && (valor === "evaluación" || valor === "invadir" || valor === "cueva")) {
        return true;
    } else if (pos === 1 && (valor === "adverbio" || valor === "deslave" || valor === "breve")) {
        return true;
    } else if (pos === 2 && (valor === "clavo" || valor === "pavo" || valor === "volver")) {
        return true;
    } else {
        return false;
    }
