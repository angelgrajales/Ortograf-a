...
var ejercicios = [
    '<tr id="fila_1"><td id="col_1_1">Signos de interrogación "¿?"</td><td id="col_1_2"></td><td id="col_1_3"></td><td id="col_1_4"></td></tr>',
    '<tr id="fila_2"><td id="col_2_1">Signos de exclamación "¡!"</td><td id="col_2_2"></td><td id="col_2_3"></td><td id="col_2_4"></td></tr>',
...
function valores(boton) {
    valor = event.target.id;
    if (pos === 0 && (valor === "btn_1" || valor === "btn_2" || valor === "btn_3")) {
        return true;

    } else if (pos === 1 && (valor === "btn_4" || valor === "btn_5" || valor === "btn_6")) {
        return true;
