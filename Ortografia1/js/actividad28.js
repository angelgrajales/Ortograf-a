...
var ejercicios = ['<tr id="fila_1"><td id="col_1_1">ca</td><td id="col_1_2"></td><td id="col_1_3"></td></tr>',
    '<tr id="fila_2"><td id="col_2_1">que</td><td id="col_2_2"></td><td id="col_2_3"></td></tr>',
    '<tr id="fila_3"><td id="col_3_1">cu</td><td id="col_3_2"></td><td id="col_3_3"></td></tr>'];
...
function califica(boton) {
    valor = $("#" + boton).text();
    if (pos === 0 && (valor === "casco" || valor === "cámara")) {
        return true;
    } else if (pos === 1 && (valor === "queso" || valor === "esqueleto")) {
        return true;
    } else if (pos === 2 && (valor === "cuna" || valor === "cuchara")) {
        return true;
    } else {
        return false;
    }
