...
var ejercicios = ['<input id="palabra_1" class="in_text4 border border-success"/>',
    ...
    '<input id="palabra_15" class="in_text4 border border-success"/>',
    '<input id="palabra_16" class="in_text4 border border-success"/>',
    '<input id="palabra_17" class="in_text4 border border-success"/>',
    '<input id="palabra_18" class="in_text4 border border-success"/>',
    '<input id="palabra_19" class="in_text4 border border-success"/>',
    '<input id="palabra_20" class="in_text4 border border-success"/>',
    '<input id="palabra_21" class="in_text4 border border-success"/>'];
