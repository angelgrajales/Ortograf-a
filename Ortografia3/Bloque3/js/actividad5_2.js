...
var ejercicios = ['<tr id="fila_1"><td id="col_1_1">Palabras con  "d"</td><td id="col_1_2"></td><td id="col_1_3"></td><td id="col_1_4"></td><td id="col_1_5"></td><td id="col_1_6"></td></tr>',
    '<tr id="fila_2"><td id="col_2_1">Palabras con "z" </td><td id="col_2_2"></td><td id="col_2_3"></td><td id="col_2_4"></td><td id="col_2_5"></td><td id="col_2_6"></td></tr>'
...
function califica(boton) {
    valor = $("#" + boton).text();
    if (pos === 0 && (valor === "caducidad" || valor === "humildad" || valor === "igualdad" || valor === "obesidad"|| valor === "realidad")) {
        return true;
    } else if (pos === 1 && (valor === "vez" || valor === "tapiz" || valor === "madurez"|| valor === "honradez"|| valor === "doblez")) {
        return true;
    }  else {
        return false;
    }
