...
var ejercicios = ['<tr id="fila_1"><td id="col_1_1">Halcón</td><td id="col_1_2"></td><td id="col_1_3"></td><td id="col_1_4"></td><td id="col_1_5"></td></tr>',
    '<tr id="fila_2"><td id="col_2_1">Bahía</td><td id="col_2_2"></td><td id="col_2_3"></td><td id="col_2_4"></td><td id="col_2_5"></td></tr>'
];
...
function califica(boton) {
    valor = $("#" + boton).text();
    if (pos === 0 && (valor != "Ocho" && valor != "Hueso" && valor != "Humo" && valor != "Hilo")) {
        return true;
    } else if (pos === 1 && (valor != "Ocho" && valor != "Hueso" && valor != "Humo" && valor != "Hilo")) {
        return true;
    } else {
        return false;
    }
