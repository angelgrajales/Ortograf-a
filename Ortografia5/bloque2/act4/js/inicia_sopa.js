function iniciaSopa() {
    var words = ["texto", "mixto", "saxofón", "máximo", "exacto", "exceleente", "claxon", "éxito", "exceso", "auxilio","expulsar","exigencia","existir","asfixia","pretexto"]; /*Poner las palabras para generar la sopa de letras*/
