function iniciaSopa() {
    var words = ["amabilidad", "debilidad", "visibilidad", "habilidad", "furibunda", "errabunda", "meditabunda", "adbunda", "tremebundo", "moribundo","vagabundo","nauseabundo"]; /*Poner las palabras para generar la sopa de letras*/
